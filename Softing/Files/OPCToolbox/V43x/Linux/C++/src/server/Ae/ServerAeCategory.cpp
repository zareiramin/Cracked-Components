...
long AeCategory::addAttribute(AeAttribute* anAttribute)
{
	...
	OTChar* otcName = (OTChar*)OTAllocateMemory((anAttribute->getName().size() + 1) * sizeof(OTChar));
...
long AeCategory::addConditionDefinition(tstring& aConditionName)
{
	...
	OTChar* otcConditionName = (OTChar*)OTAllocateMemory((aConditionName.size() + 1) * sizeof(OTChar));
	...
	tstring& aSubconditionName)
{
	...
	OTChar* otsConditionName = (OTChar*)OTAllocateMemory((aConditionName.size() + 1) * sizeof(OTChar));
	...
	OTChar* otsSubConditionName = (OTChar*)OTAllocateMemory((aSubconditionName.size() + 1) * sizeof(OTChar));
