	...
	public class OpcServer
	{
		...
		public int Initialize()
		{
			try
			{
				...
				Application.Instance.ProgIdDa = "12Softing.Console.CS.DA.1";
				Application.Instance.VerIndProgIdDa = "12Softing.Console.CS.DA";
			
				Application.Instance.ClsidAe = "{CC07E5AF-1DCE-4dcf-A900-46E4A438AC38}";
				Application.Instance.ProgIdAe = "12Softing.Console.CS.AE.1";
				Application.Instance.VerIndProgIdAe = "12Softing.Console.CS.AE";

				Application.Instance.Description = "12Softing Console OPC Server";
				Application.Instance.ServiceName ="12"+ string.Empty;
				...
				Application.Instance.VendorInfo = "Ifa Sanat";
		...
		public int Prepare(MyCreator aMyCreator)
		{
            ...
            ////	activate the COM-AE Server Feature
            	result = Application.Instance.Activate(EnumFeature.AE_SERVER, "1234-5678-1234-5678-1234");
            //if (!ResultCode.SUCCEEDED(result))
            //{
            //    return result;
            //}
