...
#Region "Public Methods"
    ...
    Public Function Initialize() As System.UInt32
      Try
        ...
        Application.Instance.ClsidDa = "{17FDDAFD-6555-42EE-B954-0F94999FA5DC}"
        Application.Instance.ProgIdDa = "Softing.OPCToolbox.NET.VB.Sample.UpdateMode.DA.1"
        Application.Instance.VerIndProgIdDa = "Softing.OPCToolbox.NET.VB.Sample.UpdateMode.DA"
        Application.Instance.Description = "Softing OPC Toolbox .NET VB UpdateMode Sample Server"
