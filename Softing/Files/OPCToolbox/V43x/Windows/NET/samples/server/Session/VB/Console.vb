...
#End Region
		...
		Shared Sub ShowObjectTree()
			...
			For Each session As MySession In sessions
	...
	Public Class ClearConsole
		...
		<DllImport("kernel32.dll", EntryPoint:="GetStdHandle", SetLastError:=True, CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.StdCall)> _
		...
		<DllImport("kernel32.dll", EntryPoint:="FillConsoleOutputCharacter", SetLastError:=True, CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.StdCall)> _
		...
		<DllImport("kernel32.dll", EntryPoint:="GetConsoleScreenBufferInfo", SetLastError:=True, CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.StdCall)> _
		...
		<DllImport("kernel32.dll", EntryPoint:="SetConsoleCursorPosition", SetLastError:=True, CharSet:=CharSet.Auto, CallingConvention:=CallingConvention.StdCall)> _
