...
#Region "Public Methods"
    ...
    Public Function Initialize() As Integer
      Try
        ...
        Application.Instance.ProgIdDa = "Softing.OPCToolbox.NET.VB.Sample.AddressSpace.DA.1"
        Application.Instance.VerIndProgIdDa = "Softing.OPCToolbox.NET.VB.Sample.AddressSpace.DA"
        Application.Instance.Description = "Softing OPC Toolbox .NET VB AddressSpace Sample Server"
	...
	Application.Instance.PatchVersion = 0
    ...
    Public Function Prepare(ByVal aMyCreator As MyCreator) As Integer
      ...
      If ResultCode.SUCCEEDED(result) Then
        ...
        Application.Instance.EnableTracing(traceGroupAll, traceGroupAll, traceGroupServer, traceGroupServer, "c:\\Trace.txt", Convert.ToUInt32(1000000), _
          Convert.ToUInt32(0))
      End If
