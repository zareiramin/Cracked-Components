...
#Region "Public Methods"
    ...
    Public Function Initialize() As System.UInt32
      Try
        ...
        Application.Instance.ProgIdDa = "Softing.OPCToolbox.NET.VB.Sample.SerialIO.DA.1"
        Application.Instance.VerIndProgIdDa = "Softing.OPCToolbox.NET.VB.Sample.SerialIO.DA"
        Application.Instance.Description = "Softing OPC Toolbox .NET VB SerialIO Sample Server"
    ...
    Public Sub AddRequsts(ByVal requests As ArrayList)
      For Each request As MyRequest In requests
        ...
        request.RequestState = EnumRequestState.PENDING
      Next
