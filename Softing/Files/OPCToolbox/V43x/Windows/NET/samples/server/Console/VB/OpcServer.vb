...
#Region "Public Methods"
		...
		Public Function Initialize() As Integer
			Try
				...
				Application.Instance.ProgIdDa = "Softing.Console.VB.DA.1"
				Application.Instance.VerIndProgIdDa = "Softing.Console.VB.DA"

				Application.Instance.ClsidAe = "{CC07E5AF-1DCE-4dcf-A900-46E4A438AC37}"
				Application.Instance.ProgIdAe = "Softing.Console.VB.AE.1"
				Application.Instance.VerIndProgIdAe = "Softing.Console.VB.AE"

				Application.Instance.Description = "Softing Console OPC Server"
