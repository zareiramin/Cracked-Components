	...
	public class OpcClient
	{
		...
		public int InitializeDaObjects()
		{
			...
			try{
				...
				//string url = "tpda://192.168.150.116:56765";
		...
		public void WriteItems(bool sync)
		{
			...
			if (sync)
			{
				ValueQT[] inValues = new ValueQT[3];
		...
		public void WriteUsingSession(bool sync)
		{
			...
			if (sync)
			{
				ValueQT[] inValues = new ValueQT[3];
				int[] inResults = new int[3];
				string[] inItemIds = new string[]{"increment.UI1 array","increment.BSTR","secure.I2"};
				int result = (int)EnumResultCode.E_FAIL;
