	...
	Public Class OpcForm
		...
		Public Sub New(ByVal anOutProc As OutProc)
			...
			Try
                ...
                Dim rootDaAddressSpaceElement As New DaAddressSpaceElement(EnumAddressSpaceElementType.BRANCH, String.Empty, String.Empty, String.Empty, IntPtr.Zero, Nothing)
