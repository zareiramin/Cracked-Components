...
Namespace AECondition
	...
	Public Class OpcForm
		...
		Private conditionStateColumnHeader As System.Windows.Forms.ColumnHeader
		Private sourceColumnHeader As System.Windows.Forms.ColumnHeader
		Private nameColumnHeader As System.Windows.Forms.ColumnHeader
		Private severityColumnHeader As System.Windows.Forms.ColumnHeader
		Private messageColumnHeader As System.Windows.Forms.ColumnHeader
		Private timeColumnHeader As System.Windows.Forms.ColumnHeader
		Private actorIDcolumnHeader As System.Windows.Forms.ColumnHeader
		Private subConditionColumnHeader As System.Windows.Forms.ColumnHeader
		Private acknowledgeButton As System.Windows.Forms.Button
		Private getConditionStateButton As System.Windows.Forms.Button
		Private enableConditionsButton As System.Windows.Forms.Button
		Private disableConditionsButton As System.Windows.Forms.Button
		Private panel2 As System.Windows.Forms.Panel
		Private conditionStateGroupBox As System.Windows.Forms.GroupBox
		Private conditionListGroupBox As System.Windows.Forms.GroupBox
		Public conditionStateRichTextBox As System.Windows.Forms.RichTextBox
		Public conditionlistView As System.Windows.Forms.ListView
...
#Region "Windows Form Designer generated code"
		...
		Private Sub InitializeComponent()
			...
			Me.conditionStateGroupBox = New System.Windows.Forms.GroupBox
			Me.conditionStateRichTextBox = New System.Windows.Forms.RichTextBox
			Me.getConditionStateButton = New System.Windows.Forms.Button
			Me.conditionListGroupBox = New System.Windows.Forms.GroupBox
			Me.conditionlistView = New System.Windows.Forms.ListView
			Me.conditionStateColumnHeader = New System.Windows.Forms.ColumnHeader
			Me.sourceColumnHeader = New System.Windows.Forms.ColumnHeader
			Me.nameColumnHeader = New System.Windows.Forms.ColumnHeader
			Me.severityColumnHeader = New System.Windows.Forms.ColumnHeader
			Me.messageColumnHeader = New System.Windows.Forms.ColumnHeader
			Me.timeColumnHeader = New System.Windows.Forms.ColumnHeader
			Me.actorIDcolumnHeader = New System.Windows.Forms.ColumnHeader
			Me.subConditionColumnHeader = New System.Windows.Forms.ColumnHeader
			Me.acknowledgeButton = New System.Windows.Forms.Button
			Me.disableConditionsButton = New System.Windows.Forms.Button
			Me.enableConditionsButton = New System.Windows.Forms.Button
			...
			' conditionlistView
			' 
			Me.conditionlistView.Columns.AddRange(New System.Windows.Forms.ColumnHeader() {Me.conditionStateColumnHeader, Me.sourceColumnHeader, Me.nameColumnHeader, Me.severityColumnHeader, Me.messageColumnHeader, Me.timeColumnHeader, _
...
#End Region
		...
		Public Sub ChangeItem(ByVal condition As Softing.OPCToolbox.Client.AeCondition, ByVal state As String)
		...
		Private Sub EnableConditionsButtonOnClick(ByVal sender As Object, ByVal e As System.EventArgs)
			...
			For Each condition As Softing.OPCToolbox.Client.AeCondition In m_subscription.AeConditionList
		...
		Private Sub GetConditionStateButtonOnClick(ByVal sender As Object, ByVal e As System.EventArgs)
			If conditionlistView.SelectedItems.Count <> 0 Then
				Dim condition As Softing.OPCToolbox.Client.AeCondition = (DirectCast(conditionlistView.SelectedItems(0).Tag, Softing.OPCToolbox.Client.AeCondition))
