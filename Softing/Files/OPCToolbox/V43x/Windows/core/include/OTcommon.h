...
//  Date        : 01-August-2012                                              |
//                                                                            |
//  Description : Programming interface of OPC Toolbox (OTB)                  |
//                                                                            |
//-----------------------------------------------------------------------------
...
#define OT_TRACEDATA_ALL         0x000000FF
...
//-----------------------------------------------------------------------------
	...
	{
		unsigned long m_errorLevelMask;
		unsigned long m_warningLevelMask;
		unsigned long m_infoLevelMask;
		unsigned long m_debugLevelMask;
		unsigned char m_enableTraceToFile;
		OTChar* m_fileName;
		unsigned long m_maxFileSize;
		unsigned long m_maxBackups;
	} OTTraceData;
