...
{
	long result = E_FAIL;
	unsigned long count = areas.size();
...
{
	long result = E_FAIL;
	unsigned long count = sources.size();
...
{
	long result = E_FAIL;
	unsigned long count = someAeConditions.size();
	...
	ExecutionOptions* someExecutionOptions)
{
	...
	unsigned long count = attributes.size();
