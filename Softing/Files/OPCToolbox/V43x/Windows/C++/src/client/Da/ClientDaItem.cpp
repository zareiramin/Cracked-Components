	...
	ExecutionOptions* someExecutionOptions)
{
	...
	pValues[0].m_pValue  = new OTCVariant(itemValue->getData());
	pValues[0].m_quality = EnumQuality_QUALITY_NOT_SET;
#ifdef TBC_OS_WINDOWS
	pValues[0].m_timestamp.dwHighDateTime = 0;
	pValues[0].m_timestamp.dwLowDateTime  = 0;
#endif
#ifdef TBC_OS_LINUX
