...
namespace I14DatabaseEvents
{
    class Program
    {
        ...
        static private S104Session slaveSesn104;
        static private S104Sector slaveSctr104;
        static private I104Channel slaveChan104;
          ...
          //  ConsoleKeyInfo key = Console.ReadKey();
           // if (key.Key == ConsoleKey.Y)
            ...
            try
            {
                ...
                //TMWTime timestamp;
                //timestamp = slaveSctr104.GetTimeStamp();
                //slaveSctr104.MspAddEvent(100, true, 1, timestamp, TMW_CHANGE_REASON.SPONTANEOUS);
                //slaveSctr104.MspAddEvent(101, true, 1, timestamp, TMW_CHANGE_REASON.SPONTANEOUS);
                //slaveSctr104.MspAddEvent(102, true, 1, timestamp, TMW_CHANGE_REASON.SPONTANEOUS);
                //slaveSctr104.MspAddEvent(103, true, 1, timestamp, TMW_CHANGE_REASON.SPONTANEOUS);
                //slaveSctr104.MspAddEvent(104, true, 1, timestamp, TMW_CHANGE_REASON.REMOTE_OP);
                //slaveSctr104.MspAddEvent(105, true, 1, timestamp, TMW_CHANGE_REASON.SPONTANEOUS);
                //slaveSctr104.MspAddEvent(106, true, 1, timestamp, TMW_CHANGE_REASON.SPONTANEOUS);
                //slaveSctr104.MspAddEvent(107, true, 1, timestamp, TMW_CHANGE_REASON.SPONTANEOUS);
                //slaveSctr104.MspAddEvent(108, true, 1, timestamp, TMW_CHANGE_REASON.SPONTANEOUS);
                //slaveSctr104.MstAddEvent(109, 100, 1, timestamp, TMW_CHANGE_REASON.SPONTANEOUS);

                //slaveDB.AddMspPoint(300, TMW_GROUP_MASK.GENERAL, 100, 10);
                //slaveDB.AddMspPoint(301, TMW_GROUP_MASK.GENERAL, 100, 10);
                //slaveDB.AddMspPoint(302, TMW_GROUP_MASK.GENERAL, 100, 10);
                slaveDB.AddMspPoint(100, TMW_GROUP_MASK.GENERAL, 250, 1);
        ...
        static void slaveDB_CcsnaSetTimeEvent(S14Database db, TMWTime time)
        {
        ...
        static byte S14Database_MspGetFlagsValueTimeEvent(int pointId, ref TMWTime time)
        {
            if (pointId == 1)
            {
                ...
                time = slaveSctr104.GetTimeStamp();
        ...
        static byte S14Database_MmenaGetValueFlagsTimeEvent(int pointId, ref byte flags, ref TMWTime time)
        {
        ...
        static Int32 S14Database_CscGetMonitoredPointEvent(Int32 pointId)
        {
            ...
            // Return 0 if you do not want it sent automatically.
            if (pointId == 20)
                return 1;
            else
                return 0;
        ...
        static void OpenSlave()
        {
            ...
            //slaveSctr104.ReadTimeFormat = IEC_TIME_FORMAT.TIME_56;
            //slaveSctr104.ReadMsrndTimeFormat = IEC_TIME_FORMAT.TIME_56;

            slaveSctr104.OpenSector();
            slaveSctr104.SendCyclic();
            slaveDB = (S14Database)slaveSctr104.SimDatabase;
