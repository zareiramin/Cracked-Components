========================================================================
         Creating the Windows CE Proxy Stub DLL for IEnumGUID
========================================================================

This proxy/stub library is required for OPCEnum to work properly on
Windows CE.

1.	Create a new Visual C++ project for Smart Device. Select the
	'Win32 Smart Device Project' template.

2.	Name the DLL project 'opcceproxy'
...
8.	On the same page enter 'opcceproxy_ps.def' to the 'Module Definition File'
	edit box.
